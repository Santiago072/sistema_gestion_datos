  ...
  fetch('/sistema_gestion_datos/controllers/dashboard_kpis.php' + qs)
    .then(r=>r.json()).then(d=>{
      const kpis = [
        ...
        {label:'No Aprobados',          val:d.total_juicios_no_aprobados, cls:'red',    icon:'M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z'},
        {label:'Programas',             val:d.total_programas,            cls:'cyan',   icon:'M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342'},
        ...
        {label:'Trasladados',           val:d.total_trasladados,          cls:'blue',   icon:'M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5'},
      ];
